        ...
        <div class="bs-body-search">
            <form>
                <div class="form-group col-xs-12 col-sm-6 col-md-3">
                    <input class="form-control"  type="text" is-open="opened" ng-click="opened = !opened" ng-model="date" placeholder="Fecha" uib-datepicker-popup="dd-MM-yyyy" datepicker-options="dateOptions" clear-text="" close-text="Cerrar" current-text="Hoy">
                    </input>
                </div>
                <div class="form-group col-xs-12 col-sm-6 col-md-3">
                    <select class="form-control" ng-change="searchAvailability()" ng-options="hour as hour.option_user for hour in hours" ng-model="availability.hour"></select>
                </div>
                <div class="form-group col-xs-12 col-sm-6 col-md-3">
                    <select class="form-control" ng-change="searchAvailability()" ng-options="guest.id as guest.name for guest in guests" ng-model="availability.num_guests"></select>
                </div>
                <div class="form-group col-xs-12 col-sm-6 col-md-3">
                    <select class="form-control" ng-change="searchAvailability()" ng-options="zone.id as zone.option for zone in zones" ng-model="availability.zone_id"></select>
                </div>
