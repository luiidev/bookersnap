                    ...
                    <div class="item" ng-repeat="hour in form.hours">
                        ...
                        <table ng-if="hour.events.length">
                            ...
                            <tr ng-class="{'b-b-0': ($index ==  form.hours.length -1) &&  hour.events.length > 1}" ng-repeat="event in hour.events" ng-if="$index > 0">
                                <td class="promo" ng-class="{'active  bs-bgm': selectedEvent.id == event.id && selectedHour.option == hour.option}" ng-click="selectHour(hour, event)" ng-mouseover="promotionDisplay(event, $event)" ng-mouseout="promotionHide()">
