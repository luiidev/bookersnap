                        ...
                        return $ocLazyLoad.load ([
                            {
                                ...
                                insertBefore: '#app-level',
                                files: [
                                    'library/bower_components/mediaelement/build/mediaelementplayer.css',
                                ]
                            },
                            {
                                name: 'library',
                                files: [
                                    'library/bower_components/mediaelement/build/mediaelement-and-player.js',
                        ...
                        return $ocLazyLoad.load ([
                            {
                                ...
                                files: [
                                    ...
                                    'library/bower_components/summernote/dist/summernote.css',
                                    'library/bower_components/eonasdan-bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.min.css',
                                    'library/bower_components/chosen/chosen.min.css'
                                ]
                            },
                            {
                                name: 'library',
                                files: [
                                    ...
                                    'library/bower_components/moment/min/moment.min.js',
                                    'library/bower_components/eonasdan-bootstrap-datetimepicker/build/js/bootstrap-datetimepicker.min.js',
                                    'library/bower_components/summernote/dist/summernote.min.js',
                    ...
                    loadPlugin: function($ocLazyLoad) {
                        return $ocLazyLoad.load ([
                            ...
                            },
                            {
                                ...
                                files: [
                                    'library/bower_components/moment/min/moment.min.js',
                                    'library/bower_components/fullcalendar/dist/fullcalendar.min.js'
                                ]
                            }
                        ])
                    }
