...
angular.module('master.app',['category.app','microsite.app']);angular.module('master.app').service('Ajax',function($http){return{Req:function(method,url,data,listener){if(listener.BeforeSend!=null&&listener.BeforeSend!=undefined){listener.BeforeSend();}
...
function showOverlay(bool){if(bool){bsLoadingOverlayService.start();}else{bsLoadingOverlayService.stop();}}});angular.module('category.service',[]).factory('CategoryListService',function(Ajax){return{GetList:function($listener){Ajax.Req('get','/v1/es/master/ajax/category',{},$listener);},DeleteCategory:function($id,$listener){Ajax.Req('delete','/v1/es/master/ajax/category/'+$id,{},$listener);}}}).factory('CategoryCreateService',function(Ajax){return{GetUrlUploadImgLogo:function(){return'/v1/es/master/ajax/category/upload/logo';},GetUrlUploadImgFavicon:function(){return'/v1/es/master/ajax/category/upload/favicon';},GetListSubcategories:function($listener){Ajax.Req('get','/v1/es/master/ajax/category/subcategories',{},$listener);},SaveCategory:function($data,$listener){Ajax.Req('post','/v1/es/master/ajax/category/',$data,$listener);}}}).factory('CategoryUpdateService',function(Ajax){return{GetUrlUploadImgLogo:function(){return'/v1/es/master/ajax/category/upload/logo';},GetUrlUploadImgFavicon:function(){return'/v1/es/master/ajax/category/upload/favicon';},GetCategory:function($id,$listener){Ajax.Req('get','/v1/es/master/ajax/category/'+$id,{},$listener);},GetListSubcategories:function($listener){Ajax.Req('get','/v1/es/master/ajax/category/subcategories',{},$listener);},SaveCategory:function($id,$data,$listener){Ajax.Req('put','/v1/es/master/ajax/category/'+$id,$data,$listener);}}});angular.module('microsite.app',['microsite.controller','microsite.service']).config(function($stateProvider){$stateProvider.state('microsite-list',{url:'/microsite',templateUrl:'/js/app/master/microsite/view/microsite-list.html',controller:'MicrositeListController',controllerAs:'vm'}).state('microsite-add',{url:'/microsite/add',templateUrl:'/js/app/master/microsite/view/microsite-create.html',controller:'MicrositeCreateController',controllerAs:'vm'})});angular.module('microsite.controller',['bsLoadingOverlay']).run(function(bsLoadingOverlayService){bsLoadingOverlayService.setGlobalConfig({delay:0,activeClass:undefined,templateUrl:'overlay-template.html',templateOptions:undefined});}).controller('MicrositeListController',function(){}).controller('MicrositeCreateController',function(){})
