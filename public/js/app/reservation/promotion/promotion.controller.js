angular.module('promotion.controller', ['infinite-scroll','ui.sortable','sortable','LocalStorageModule','ngFileUpload','ngImgCrop','textAngular','ngEmoticons','farbtastic','localytics.directives'])
.controller('PromotionCtrl', function($scope) {

  $scope.titulo="Promociones";
	
})
.controller('PromotionListCtrl', function($scope,$http) {
  ...
  $scope.loadMore = function() {
   ...
   $scope.init = function () {
        ...
        $scope.promociones = [];
        $http.get("http://192.168.0.107/api.promociones/public/v1/es/microsites/1/promotions")
    ...
    /* Se entrega la nueva lista ordenada*/
    ...
    /* Funciones para mover la promoción */ 
