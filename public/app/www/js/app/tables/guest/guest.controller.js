angular.module('guest.controller', [])
	...
	.controller('GuestViewCtrl', function(GuestFactory, GuestDataFactory, $stateParams, $ionicLoading) {
		var vm = this;
	...
	.controller('GuestCreateCtrl', function(GuestFactory, GuestDataFactory, $compile, $scope, $state, $stateParams, $ionicLoading) {
		var vm = this;
		...
		vm.validaSaveGuest = function(frmGuest) {
			...
			if (frmGuest.$valid) {
				...
				messageAlert("Alerta", "Los datos no son correctos", "info", 2000);
			}
		};
		...
		vm.saveGuest = function() {
			...
			loadingShow($ionicLoading, "Guardando información ...");
